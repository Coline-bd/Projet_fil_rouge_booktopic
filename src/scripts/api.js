...
async function searchBook() {
    ...
    //       console.log(dataBooks);
          ...
          //   coverCard.alt = dataTest[i].volumeInfo.title;
          //   linkCoverCard.append(coverCard);
          //   cardBook.append(linkCoverCard);
          //   const linkTitleCard=document.createElement('a');
          //   linkTitleCard.textContent=dataTest[i].volumeInfo.title;
          //   linkTitleCard.classList.add('titleCardBook');
          //   cardBook.append(linkTitleCard);
          //   const authorCard=document.createElement('span');
          //   authorCard.textContent=dataTest[i].volumeInfo.authors?.join(", ");
          //   cardBook.append(authorCard);
          //   const categoryCard = document.createElement('span');
          //   categoryCard.textContent=dataTest[i].volumeInfo.categories?.join(",");
          //   cardBook.append(categoryCard);
          //   const addBtn=document.createElement('button');
          //   addBtn.classList.add('addBtn');
          //   addBtn.type='button';
          //   addBtn.textContent="Ajouter";
          //   cardBook.append(addBtn);
