...
class CommentRepository extends Repository{
    ...
    public function findByBookId(int $id): ?array{
        try{
            $req=$this->getDatabase()->getConnection()->prepare("SELECT c.id_comment,date_comment,content_comment,c.id_user,c.id_book,u.login_user,u.picture_user FROM comment as c 
