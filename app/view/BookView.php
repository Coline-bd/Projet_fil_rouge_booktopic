    ...
    <main>
        <nav class="breadcrumb" aria-label="fil d'ariane">
            <ol>
                ...
                <li id="currentPage" aria-current="page"><?= $this->book->getTitle() ?></li>
            </ol>
        </nav>
        <div id="mainSection">
            <section id="bookSection">
                <div class="containerCol">
                    <img id="bookCover" src=<?= $this->book->getCover()?? "/images/imgDefault.png" ?>>
                    <button class="addBtn" aria-label="ajouter à ma liste" type="button">Ajouter à ma liste</button>
                </div>
                <div class="containerCol">
                    <h1 id="bookTitle"><?= $this->book->getTitle()??"" ?></h1>
                    <p id="subtitle"><?= $this->book->getSubTitle()??"" ?></p>
                    <p class="author">De <?= $this->book->getAuthor()??"" ?></span></p>
                    <p id="bookCategory"></p>
                    <div>
                        <p>Date de parution : <?= $this->book->getPublishDate()??"" ?></p>
                    </div>
                    <div>
                        <p>Edition : <?= $this->book->getEditor() ??"" ?></p>
                    </div>
                    <p id="bookDescription"><?= $this->book->getSummary()??"" ?></p>
                </div>
            </section>
            <section class="commentsSection" aria-labelledby="commentsTitle">
                <article class="cardComment commentComposer">
                    <div class="containerRow">
                        <div>
                            <img class="profileFoto" src=<?= $_SESSION["picture_user"]??"" ?>>
                        </div>
                        <div class="containerCol">
                            <a href="#" class="pseudo"><?= $_SESSION["pseudo_user"] ?></a>
                ...
                <div class="containerRow">
                    ...
                    <div class="containerCol">
                        <a href="/user/<?= $comment->getLoginAuthor() ?>" class="pseudo"><?= $comment->getLoginAuthor() ?></a>
